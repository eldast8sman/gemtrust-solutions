                            ...
                            <div class="v-text-align v-line-height" style="color: #536475; line-height: 180%; text-align: left; word-wrap: break-word;">
                                ...
                                <p style="font-size: 14px; line-height: 180%;">
                                    <span style="font-size: 16px; line-height: 28.8px; font-family: 'trebuchet ms', geneva;">
                                        Please find below the Latest Signal from Gemtrust
                                        <br />
                                        ...
                                        <table border="1">
                                            ...
                                            <tr>
                                                <th>Take Profit</th>
                                                <td>{{ $data['take_profit1'] }}</td>
                                            </tr>
                                            @if (!empty($data['take_profit2']))
                                                <tr>
                                                    <th>Take Profit</th>
                                                    <td>{{ $data['take_profit2'] }}</td>
                                                </tr> 
                                            @endif
                                            @if (!empty($data['take_profit3']))
                                                <tr>
                                                    <th>Take Profit</th>
                                                    <td>{{ $data['take_profit3'] }}</td>
                                                </tr> 
                                            @endif
                                        </table>
                                    </span>
                                ...
                                <p style="font-size: 14px; line-height: 180%;"><br /><strong><span style="font-size: 16px; line-height: 28.8px; font-family: 'trebuchet ms', geneva;">Best regards,</span></strong><br /><span style="font-size: 16px; line-height: 28.8px; font-family: 'trebuchet ms', geneva;">{{ $data['sender'] }}</span></p>
                            </div>
