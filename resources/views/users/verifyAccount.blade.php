                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="pt-4 pb-2">
                                        ...
                                        <p class="text-center small">We are happy you're here, get your Email Address verified</p>
                                    </div>

                                    <div class="col-12">
                                        <button class="btn btn-primary w-100" id="btnFunc" type="button" onclick="activateAccount()">Click to Verify Email</button>
                                    </div>
