...
<head>
  ...
  <title>Login || User Dashboard || Gemtrust</title>
</head>
        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                  ...
                  <form class="row g-3 needs-validation">
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        <input type="text" class="form-control" id="emailAddress" placeholder="Please enter your Email Address">
                      </div>
                    </div>
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Forgot password? <a href="/users/forgotPassword">reset your password now</a></p>
                    </div>

                    <div class="col-12">
                      <button class="btn btn-primary w-100" type="button" id="btnFunc" onclick="userLogin()">Login</button>
                    </div>
                    <div class="col-12">
                      <p class="small mb-0">Don't have account? <a href="/users/registration">Create an account</a></p>
                    </div>
                  </form>
              ...
              <div class="credits">
                Developed by <a href="">Prosper JS</a>
              </div>
