                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="pt-4 pb-2">
                                        ...
                                        <p class="text-center small">Please fill in the required to reset your password</p>
                                    </div>
                                    ...
                                    <form class="row g-3 needs-validation">
                                        ...
                                        <div class="col-12">
                                            <button class="btn btn-primary w-100" id="btnFunc" type="button" onclick="resetPassword('{{ $token }}')">Save Password</button>
                                        </div>
                                    </form>
