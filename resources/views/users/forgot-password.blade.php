...
<head>
    ...
    <title>Forgot Password || User Dashboard || Gemtrust</title>
</head>
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="pt-4 pb-2">
                                        ...
                                        <p class="text-center small">Please input your Email Address to reset your password</p>
                                    </div>

                                    <form class="row g-3 needs-validation">
                                        <div class="col-12">
                                            <label for="emailAddress" class="form-label">Your Email</label>
                                            <input type="email" class="form-control" id="emailAddress" placeholder="Enter a valid Email adddress">
                                        </div>

                                        <div class="col-12">
                                            <button class="btn btn-primary w-100" id="btnFunc" type="button" onclick="forgotPassword()">Reset Password</button>
                                        </div>
                                    </form>
