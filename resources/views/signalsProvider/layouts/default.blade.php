...
<head>
    ...
    @include('signalsProvider.includes.head')
</head>
...
<body>
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            @include('signalsProvider.includes.sidebar')
        </div>
        <!-- Sidebar End -->
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                @include('signalsProvider.includes.header')
            </nav>
            <!-- Navbar End -->
            ...
            <div class="container-fluid pt-4 px-4">
                @include('signalsProvider.includes.footer')
            </div>
            <!-- Footer End -->
